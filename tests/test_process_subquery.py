...
def test_process_subquery_simple():
    ...
    assert(extract_tables.process_subquery(sql_str) == [('TABLE1', 'TABLE1')])
...
def test_process_subquery_tables_with_alias():
    ...
    assert(extract_tables.process_subquery(sql_str) == [('TABLE2', 'T2'), ('TABLE3', 'T3'), ('TABLE4', 'T4')])
...
def test_process_subquery_tables_union_simple():
    ...
    assert(extract_tables.process_subquery(sql_str) == [('TABLE1', 'TABLE1'), ('TABLE2', 'TABLE2')])
...
def test_process_subquery_tables_union_with_alias():
    ...
    assert(extract_tables.process_subquery(sql_str) == [('TABLE1', 'T1'), ('TABLE2', 'T2'), ('TABLE3', 'T3')])
