...
def test_process_other_join_types_left_join_2_tables():
    ...
    assert(parse4.process_other_join_types(table_line)) == ['TABLE1','TABLE2']
...
def test_process_other_join_types_left_outer_join_3_tables():
    ...
    assert(parse4.process_other_join_types(table_line)) == ['TABLE1','TABLE2', 'TABLE3']
...
def test_process_other_join_types_left_join_2_tables_both_with_alias():
    ...
    assert(parse4.process_other_join_types(table_line)) == ['TABLE1 AS T1','TABLE2 AS T2']
...
def test_process_other_join_types_left_join_2_tables_first_with_alias():
    ...
    assert(parse4.process_other_join_types(table_line)) == ['TABLE1 AS T1','TABLE2']
...
def test_process_other_join_types_left_join_2_tables_second_with_alias():
    ...
    assert(parse4.process_other_join_types(table_line)) == ['TABLE1','TABLE2 AS T2']
...
def test_process_other_join_types_left_outer_join_3_tables_all_with_alias():
    ...
    assert(parse4.process_other_join_types(table_line)) == ['TABLE1 AS T1','TABLE2 AS T2', 'TABLE3 AS T3']
