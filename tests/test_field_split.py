...
def test_field_split():
    ...
    print(parse4.field_split(sql_str))
#    assert(parse4.field_split(sql_str) == [' table_name1.column_name1 AS column_alias1', ' table_name2.column_name2 AS column_alias2', ' table_name3.column_name3 AS column_alias3'])
    assert(parse4.field_split(sql_str) == ['table_name1.column_name1 AS column_alias1', 'table_name2.column_name2 AS column_alias2'])
...
def test_field_split_derivation():
    ...
    print(parse4.field_split(sql_str))
#    assert(parse4.field_split(sql_str) == [' table_name1.column_name1 AS column_alias1', ' table_name2.column_name2 AS column_alias2', ' table_name3.column_name3 AS column_alias3'])
    assert(parse4.field_split(sql_str) == ['table_name1.column_name1 AS column_alias1', ' "substring"(protocol_instance.md_compound_name::text, 1, 11) AS parent_id_metid', 'table_name2.column_name2 AS column_alias2'])
